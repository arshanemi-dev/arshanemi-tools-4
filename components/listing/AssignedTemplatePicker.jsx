    ...
    return (
      <div className="min-h-[70vh] bg-gray-50 px-6 py-6">
        <p className="text-[13px] text-gray-400">
          ...
          <Link href="/listing-tools/templates" className="text-indigo-600 hover:underline">Choose Your template</Link>{' '}
          to pick one.
        </p>
      </div>
    )
        ...
        {templates.map((t) => (
          <li key={t.templateId}>
            <Link
              ...
              className="flex items-center gap-2.5 px-3 py-2 rounded-md text-[13.5px] font-medium text-gray-700 hover:bg-white hover:shadow-sm transition-colors"
            >
