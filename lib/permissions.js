...
// Companies/Users/Theme/Profile — the rest of the full CMS nav (and the
// tools catalog / per-user tools access screens) from the root
// arshanemi-admin-pannels app doesn't apply here.
...
export const NAV_CONFIG = [
  ...
  // No LISTING TOOLS group here anymore — both settings pages that used to
  // live under it moved into the Listing Tools app itself:
  // app/listing-tools/template-access/page.js (create/edit-role access) and
  // (removed outright, no longer manageable anywhere) the old per-user
  // template grants page that used to sit at /settings/listing-templates.
  {
    label: 'ACCOUNT',
    items: [
