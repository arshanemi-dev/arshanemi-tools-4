...
export const NAV_CONFIG = [
  ...
  },
  {
    label: 'LISTING TOOLS',
    items: [
      { key: 'listing-templates', label: 'Template Access', href: '/settings/listing-templates', icon: 'Table2', roles: ['master_admin', 'admin'] },
      { key: 'listing-tools-config', label: 'Create/Edit Access', href: '/settings/listing-tools-config', icon: 'Lock', roles: ['master_admin'] },
    ],
  },
  {
    label: 'ACCOUNT',
