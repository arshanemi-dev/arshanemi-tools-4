...
// product images.
//
// No delete-on-replace/delete-on-remove here — Dropbox's shared-link URL
// (what this returns and what templates persist) has no reversible mapping
// back to the original file path the way Supabase's public-URL scheme did,
// so there's nothing to call filesDeleteV2 with later. Same tradeoff the
// product-image upload path (app/api/listing-tools/[templateId]/images)
// already lives with — a replaced/deleted template's old file is simply
// orphaned in Dropbox, not actively cleaned up.
